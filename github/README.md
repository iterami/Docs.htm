...
iterami searches:
* [:two: 2D repositories](https://github.com/search?q=org%3Aiterami+-2D)
* [:two::three: 2D3D repositories](https://github.com/search?q=org%3Aiterami+-2D3D)
* [:three: 3D repositories](https://github.com/search?q=org%3Aiterami+-3D)
* [:three::two: 3D2D repositories](https://github.com/search?q=org%3Aiterami+-3D2D)
* [:european_castle: Age of Mythology repositories](https://github.com/search?q=org%3Aiterami+AoM-)
* [:computer: Assembly repositories](https://github.com/search?q=org%3Aiterami+.asm)
* [:computer: C++ repositories](https://github.com/search?q=org%3Aiterami+.cpp)
* [:traffic_light: Chrome repositories](https://github.com/search?q=org%3Aiterami+Chrome-)
* [:point_left: Clicker Heroes repositories](https://github.com/search?q=org%3Aiterami+CH-)
* [:japanese_ogre: Diablo 2: Lord of Destruction repositories](https://github.com/search?q=org%3Aiterami+D2LoD-)
* [:droplet: Drupal repositories](https://github.com/search?q=org%3Aiterami+Drupal-)
* [:japanese_goblin: Dungeon Siege repositories](https://github.com/search?q=org%3Aiterami+DS-)
* [:milky_way: EVE Online repositories](https://github.com/search?q=org%3Aiterami+EVE-)
* [:heavy_exclamation_mark::twisted_rightwards_arrows: fewest forked iterami repositories](https://github.com/search?o=asc&q=org%3Aiterami&s=forks)
* [:heavy_exclamation_mark::star: fewest starred iterami repositories](https://github.com/search?o=asc&q=org%3Aiterami&s=stars)
* [:octocat: GitHub repositories](https://github.com/search?q=org%3Aiterami+GitHub-)
* [:black_joker: Hearthstone repositories](https://github.com/search?q=org%3Aiterami+HS-)
* [:scroll: HTML repositories](https://github.com/search?q=org%3Aiterami+.htm)
* [:warning: issues](https://github.com/search?o=desc&q=is%3Aissue+org%3Aiterami&s=updated&type=Issues)
* [:shipit: JavaScript repositories](https://github.com/search?q=org%3Aiterami+.js)
* [:twisted_rightwards_arrows: most forked iterami repositories](https://github.com/search?o=desc&q=org%3Aiterami&s=forks)
* [:star: most starred iterami repositories](https://github.com/search?o=desc&q=org%3Aiterami&s=stars)
* [:factory: PHP repositories](https://github.com/search?q=org%3Aiterami+.php)
* [:books: Planescape: Torment repositories](https://github.com/search?q=org%3Aiterami+PT-)
* [:arrow_heading_up: Plugin repositories](https://github.com/search?q=org%3Aiterami+plugin)
* [:arrow_heading_up: pull requests](https://github.com/search?o=desc&q=is%3Apr+org%3Aiterami&s=updated&type=Issues)
* [:snake: Python repositories](https://github.com/search?q=org%3Aiterami+.py)
* [:moneybag: RuneScape repositories](https://github.com/search?q=org%3Aiterami+RS-)
* [:sparkles: StarCraft repositories](https://github.com/search?q=org%3Aiterami+SC-)
* [:tophat: Team Fortress 2 repositories](https://github.com/search?q=org%3Aiterami+TF2-)
* [:city_sunset: World of Warcraft repositories](https://github.com/search?q=org%3Aiterami+WoW-)
